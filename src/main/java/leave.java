...
public class leave extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            // 调用方法插入数据
            if (userleave(connection, username,type,startTime,endTime,reason)) {
                // 如果插入成功，发送成功响应
    ...
    // 插入签到信息
    private boolean userleave(Connection connection, String username , String type, String startTime,String endTime,String reason) throws SQLException {
        String sql = "INSERT INTO ask_for_leave_info (wno, listate, litime,lireason) VALUES (?, ?, ?, ?)";
