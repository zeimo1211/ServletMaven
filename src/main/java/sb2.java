...
@WebServlet("/sb2")
public class sb2 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        JsonArray arrivals = fetchleaves2FromDB(startTime, endTime);
    ...
    private JsonArray fetchleaves2FromDB(String startTime, String endTime) {
        ...
        try  {
            ...
            CallableStatement cstmt = conn.prepareCall("{CALL GetLeave2Records(?, ?)}");
