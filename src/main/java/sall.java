...
public class sall extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        JsonArray arrivals = fetchArrivalsFromDB(startTime, endTime);
    ...
    private JsonArray fetchArrivalsFromDB(String startTime, String endTime) {
        ...
        try  {
            ...
            CallableStatement cstmt = conn.prepareCall("{CALL CalculateArrivals(?, ?)}");
            ...
            while (rs.next()) {
                ...
                System.out.println("获取结果：wno: " + rs.getInt("wno") + ", wname: " + rs.getString("wname"));
            }
        }
