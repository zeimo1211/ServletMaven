...
public class sc2 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        JsonArray arrivals = fetchbusiness2FromDB(startTime, endTime);
    ...
    private JsonArray fetchbusiness2FromDB(String startTime, String endTime) {
        ...
        try  {
            ...
            CallableStatement cstmt = conn.prepareCall("{CALL Getbusiness2Records(?, ?)}");
            ...
            while (rs.next()) {
                JsonObject jsonObject = Json.createObjectBuilder()
                        ...
                        .add("bistate", rs.getString("bistate"))
                        .add("bitime", rs.getString("bitime"))
                        .add("bireason", rs.getString("bireason"))
                        .build();
    ...
    private String buildJsonString(JsonArray jsonArray) {
        ...
        for (int i = 0; i < jsonArray.size(); i++) {
            ...
            jsonString.append("\"bitime\":\"").append(jsonObject.getString("bitime")).append("\",");
            jsonString.append("\"bireason\":\"").append(jsonObject.getString("bireason")).append("\"");
            jsonString.append("}");
