...
public class sc extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        JsonArray arrivals = fetchbusinessFromDB(startTime, endTime);
    ...
    private JsonArray fetchbusinessFromDB(String startTime, String endTime) {
        ...
        try  {
            ...
            CallableStatement cstmt = conn.prepareCall("{CALL GetbusinessRecords(?, ?)}");
